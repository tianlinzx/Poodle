package com.gzs.audit.web.rest;

import com.gzs.audit.config.Constants;
import com.gzs.audit.PoodleApp;
import com.gzs.audit.domain.Authority;
import com.gzs.audit.domain.User;
import com.gzs.audit.repository.AuthorityRepository;
import com.gzs.audit.repository.UserRepository;
import com.gzs.audit.security.AuthoritiesConstants;
import com.gzs.audit.service.MailService;
import com.gzs.audit.service.dto.UserDTO;
import com.gzs.audit.web.rest.errors.ExceptionTranslator;
import com.gzs.audit.web.rest.vm.KeyAndPasswordVM;
import com.gzs.audit.web.rest.vm.ManagedUserVM;
import com.gzs.audit.service.UserService;
...
@SpringBootTest(classes = PoodleApp.class)
